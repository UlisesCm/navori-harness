# navori:managed start id="routing-watch-base" hash="0148d644" version="0.9.0" source="@navori/core"
#!/usr/bin/env bash
#
...
# GENERATED by `bun run gen:schemas` from packages/cli/src/lib/source-classify.ts.
