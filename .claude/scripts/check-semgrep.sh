# navori:managed start id="semgrep-script-check-semgrep" hash="fe28d68f" version="0.10.1" source="@navori/plugin-semgrep"
#!/usr/bin/env bash
...
# navori:managed end id="semgrep-script-check-semgrep"
