# navori:managed start id="jscpd-script-check-jscpd" hash="2fb09028" version="0.10.1" source="@navori/plugin-jscpd"
#!/usr/bin/env bash
...
exit 1
# navori:managed end id="jscpd-script-check-jscpd"
