...
<!-- navori:managed id="publisher-base" hash="cbfad3bb" version="0.10.1" source="@navori/core" fmkeys="name,description,tools,model,effort,maxWords" -->
# Publisher Agent
...
<!-- navori:managed id="gh-comment-channel-publisher" hash="c45676f1" version="0.10.1" source="@navori/plugin-gh" -->
