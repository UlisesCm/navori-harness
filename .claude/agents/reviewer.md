...
<!-- navori:managed id="reviewer-base" hash="ae93544f" version="0.8.2" source="@navori/core" -->
# Reviewer Agent
...
3. **Re-run `pnpm format:check && pnpm check:render && pnpm check:assets && pnpm --filter @navori/website build && cd packages/cli && pnpm check:size && pnpm test:coverage && pnpm lint && pnpm typecheck` anyway**, over the live bytes. The previous green expired the moment the bytes changed, and that evidence is what the pilot reuses.
...
|---|---|---|
| `pnpm format:check && pnpm check:render && pnpm check:assets && pnpm --filter @navori/website build && cd packages/cli && pnpm check:size && pnpm test:coverage && pnpm lint && pnpm typecheck` | [x] / [ ] | <output or exit code from this turn> |
...
- ❌ Never approve with `pnpm format:check && pnpm check:render && pnpm check:assets && pnpm --filter @navori/website build && cd packages/cli && pnpm check:size && pnpm test:coverage && pnpm lint && pnpm typecheck` red.
...
<!-- navori:managed id="engram-reviewer-extension" hash="b5d6fc69" version="0.8.2" source="@navori/plugin-engram" -->
...
<!-- navori:managed id="codegraph-reviewer-extension" hash="76ce6f81" version="0.8.2" source="@navori/plugin-codegraph" -->
...
<!-- navori:managed id="tgrep-reviewer-extension" hash="fcf9f325" version="0.8.2" source="@navori/plugin-tgrep" -->
