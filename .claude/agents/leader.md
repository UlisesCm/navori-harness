...
<!-- navori:managed id="leader-base" hash="f1ef7837" version="0.5.0" source="@navori/core" -->
...
pnpm format:check && cd packages/cli && pnpm test && pnpm lint    # full gate — before closing the session / creating the PR
```
...
<!-- navori:managed id="engram-leader-extension" hash="ae03e502" version="0.5.0" source="@navori/plugin-engram" -->
