...
tools: Read, Glob, Grep, Bash, Write, WebFetch, WebSearch, mcp__codegraph__*, mcp__engram__mem_search, mcp__engram__mem_get_observation, mcp__engram__mem_save
model: sonnet
effort: medium
maxWords: 1650
---

<!-- navori:managed id="auditor-base" hash="6fb9e844" version="0.10.1" source="@navori/core" fmkeys="name,description,tools,model,effort,maxWords" -->
# Auditor Agent
...
<!-- navori:managed id="engram-auditor-extension" hash="b6941b23" version="0.10.1" source="@navori/plugin-engram" -->
...
<!-- navori:managed id="codegraph-access-v2-auditor" hash="5ac84549" version="0.10.1" source="@navori/plugin-codegraph" -->
