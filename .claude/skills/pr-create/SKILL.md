...
<!-- navori:managed id="pr-create" hash="d2f4cebb" version="0.6.0" source="@navori/core" -->
...
(`pnpm format:check && cd packages/cli && pnpm test && pnpm lint && pnpm typecheck` green), the review/R1 handling, the body template and the
