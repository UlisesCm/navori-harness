...
<!-- navori:managed id="author-skill" hash="3cdc94e2" version="0.9.0" source="@navori/core" fmkeys="name,description,metadata" -->
# Authoring a skill
...
2. Knowledge no installed skill covers → `.claude/skills/<id>/SKILL.md`, listed in `project.localSkills`.
