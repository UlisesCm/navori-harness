...
<!-- navori:managed id="loop-back-debug-base" hash="25c7bebc" version="0.4.2" source="@navori/core" -->
# Loop-Back Debug
...
<!-- user: add here bug patterns specific to your repo where the typical hypothesis fails. Suggestions:
     ...
     - Half-done migrations (legacy/<not configured: project.legacyPaths> → new backend) that create inconsistent states.
