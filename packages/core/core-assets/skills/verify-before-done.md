...
`CLAUDE.md` § Session closeout mentions `{{qualityGate.full}}` green; this skill adds the "fresh evidence" rigor plus the UI / bug-fixed dimensions the quality gate doesn't touch.
