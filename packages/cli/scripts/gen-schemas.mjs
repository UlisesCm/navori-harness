...
export function serializeClassifyPartial() {
  ...
  return `# GENERATED by \`pnpm gen:schemas\` from packages/cli/src/lib/source-classify.ts.
...
export function serializeClassifyRules() {
  return `${JSON.stringify(
    {
      $comment:
        "GENERATED by `pnpm gen:schemas` from packages/cli/src/lib/source-classify.ts. Do not edit: edit the module.",
...
export function serializeActivationAliases() {
  return `${JSON.stringify(
    {
      $comment:
        "GENERATED by `pnpm gen:schemas` from packages/cli/src/lib/activation-aliases.ts. Do not edit: edit the module.",
