...
const ES: Strings = {
  ...
  presetGapNotice: (stack) =>
    ...
    `Para cubrir el hueco: crea un preset local con 'navori preset init ${stack}', instala uno con ` +
    `'navori preset add <paquete>', o agrega skills sueltas en project.localSkills.`,
...
const EN: Strings = {
  ...
  presetGapNotice: (stack) =>
    ...
    `To cover the gap: scaffold a local preset with 'navori preset init ${stack}', install one with ` +
    `'navori preset add <package>', or add individual skills via project.localSkills.`,
