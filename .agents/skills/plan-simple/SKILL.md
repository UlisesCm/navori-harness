...
<!-- navori:managed id="plan-simple" hash="d335147f" version="0.10.1" source="@navori/core" fmkeys="name,description,metadata" -->
# plan-simple — level-1 workplan

## Steps

1. Draft `.codex/progress/workplan_<feature>.json`: a one-line observable goal; 1 to 5
