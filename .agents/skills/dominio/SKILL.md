...
<!-- navori:managed id="dominio" hash="0e526e1d" version="0.10.0" source="@navori/core" fmkeys="name,description,metadata" -->
...
Single-repo detail → that repo's `AGENTS.md`. Personal preferences → engram.
