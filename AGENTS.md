...
<!-- navori:managed id="navori-agents" hash="06c9990e" version="0.10.1" source="@navori/core" -->
...
- **Before dispatching**, run `navori handoff check <feature> --dir .codex/progress --json`; continue only on `"status":"ok"`.
