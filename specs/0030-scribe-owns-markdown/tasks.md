...
- [ ] **T6** (R1–R10, R13) · implementer — `bun run --filter navori build`, `node packages/cli/dist/index.js render --apply`, snapshots de render y full gate · test: `check:render` y las suites de T1–T5 en verde.
